			...
			$j = 1;
 			while( $get_featured_pages->have_posts() ):$get_featured_pages->the_post();
				...
				<div class="<?php echo $service_class; ?>">
					...
					?>
					<?php echo $before_title; ?><a title="<?php the_title_attribute(); ?>" href="../booking"><?php echo $page_title; ?></a><?php echo $after_title; ?>
					<?php the_excerpt(); ?>
		<!-- 			<div class="more-link-wrap">
						<a class="more-link" title="<?php the_title_attribute(); ?>" href="../booking"><?php _e( 'Book now','spacious' ); ?></a>	
					</div>	 -->				
				</div>
				<?php $j++; ?>					
			<?php endwhile;
